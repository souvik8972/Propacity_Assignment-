...
const StorageChart = () => {
  ...
  return (
    <div className='w-[17vw] rounded-xl rounded-e-none m-auto bg-white h-[100%]'>
      ...
      <h2 className='text-center mt-3 rounded p-1 border border-dashed bg-inFile text-white '>Need More Space ?</h2>
       <h2 className='text-center p-1 border border-dashed bg-inFile text-white '>Upgrade to Prime</h2>
